/**
 * @descripion
 * The file app.js provides the funcionality to create a Google Map, resort objects in a list view, binds them
 * to the map markers and search window. The object properties are dinamicly updated in UI via knockoutJS
...
var app = function() {
    ...
    /**
     * @todo Implement $.getJSON( Model data) to request Model data
     */
    ...
    var resortLocations = [
        ...
        {
            placeName: "Aspen Mountain (ski area)",
            lat: 39.641667,
            lon: -105.871667,
            id:"3",
            cityId: 5412230
    ...
    /**
     * Asynchronous ajax request to Open Weather Map API http://openweathermap.org/current/ project5/
     * @function - fired with the clicks on map marker or View list element events
     * @param {object} resort -
     * @param {object} infowindow - The author of the book.
     */
    ...
    var MyViewModel = function() {
        ...
        self.mappedArray = ko.mapping.fromJS(self.resortList());
        ...
        self.filteredRecords = ko.computed(function() {
            return ko.utils.arrayFilter(self.mappedArray(), function(r) {
